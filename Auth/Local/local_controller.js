...
const {
  getUserByEmail,
  getUser,
} = require('../../Users/user_services');

const { signToken } = require('../auth_services');
...
async function changePasswordHandler(req, res) {
  ...
  try {
    const user = await getUser({ passwordResetActivationToken: token });
...
async function forgotPasswordHandler(req, res) {
  ...
  try {
    ...
    const message = {
      ...
      subject: 'Welcome to Marflex! Activate your Account Now.', // Subject line
